\input{cross_sections/trapezoid_figure}
...
\end{align}
Similarly, we consider a coordinate system with $(\vec{\hat v_l}, \vec{\hat o_l})$ as the basis.
...
\input{cross_sections/trapezoidZ_figure}
