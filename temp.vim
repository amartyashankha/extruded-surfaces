...
silent only
cd ~/Origami/extruded-surfaces/orthogonal
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +45 ~/Origami/extruded-surfaces/main.tex
badd +36 ~/Origami/extruded-surfaces/cross_sections/evolution.tex
badd +44 orthogonal.tex
badd +70 construction.tex
badd +23 grid.tex
badd +6 connector.tex
badd +22 size.tex
badd +17 optimal.tex
argglobal
silent! argdel *
...
setlocal indentkeys=0{,0},:,0#,!^F,o,O,e,},],=^s*^s*^s*^s*^s*^s*^s*^s*^s*^s*^s*^s*^s*^s*\\bibitem,=\\item
